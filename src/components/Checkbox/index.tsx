...
const Checkbox = ({  checked, onClick,children }:CheckboxProps) => {
  ...
  return (
    <div className="meraki-checkbox">
      <div className="meraki-checkbox__check">
        <input type="checkbox" id="checkbox" checked={isChecked}/>
        <label htmlFor="checkbox" onClick={()=>handleClick()} className={isChecked?'checked':''}>
